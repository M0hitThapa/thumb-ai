...
export const NoiseBackground = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "group relative overflow-hidden rounded-2xl bg-neutral-100 p-2 backdrop-blur-sm dark:bg-neutral-900",
    ...
    >
      ...
      <motion.div
        className="absolute inset-x-0 top-0 h-1.5 rounded-t-2xl opacity-100 blur-[2px]"
        style={{
